<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#admitted_list').DataTable(
            {
                ajax:
                    {
                        type: 'GET',
                        url: 'data/admitted_list_equivalent.php',
        ...
        if(isset($_POST['doSearch'])=="Search Records")
        {
            ...
            <div class="col-lg-12">
                <h4><span id="titleheader">List of Approved Applicants for <?php echo $db->getData("programs","programName","programID",$programmeID); ?>
                        <?php echo $db->getData('admission_setting',"admissionName","admissionID",$admissionID); ?>-Equivalent Entry</span></h4>
            </div>
            <table id="admitted_list" class="display nowrap" cellspacing="0">
                <thead>
                <tr>
                    <th>Name</th>
                    <th>Sex</th>
