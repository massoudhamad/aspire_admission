...
<form class="form-horizontal" name="register" id="register" action="action_edit_programme_choice.php" method="post">   
<div class="col-lg-12">    
              ...
              <div class="well">
                ...
                $studyLevelID=$db->getData("applicantstudylevel","studyLevelID","applicantID",$applicantID);
                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <input type="submit" name="doExit" value="Proceed to Application" class="btn btn-success form-control" />
                        </div>
                        <?php
                        }
                        else
