...
if(isset($_REQUEST['action_type']) && !empty($_REQUEST['action_type'])){
        ...
        if($boolStatus)
        {
            header("Location:index2.php?sz=registration_form");
            //header("Location:index2.php?sz=programme_choice_verification");
        }
        else
        {
            header("Location:index2.php?sz=programme_choice&msg=unsucc");
        }
}
if(isset($_POST['doExit']))
{
    ...
    $db->redirect("index2.php?sz=programme_choice&msg=error");
}