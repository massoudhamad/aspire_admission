        ...
        <form name="" method="post" action="">
            <div class="col-lg-3">
                ...
                <select name="programmeID" class="form-control chosen-select" required="">
                    <?php
                    $adYear = $db->getStudyLevelProgrammes(1);
                    if(!empty($adYear)){
            ...
            <div class="col-md-12">
                <!--<form name="register" id="register" method="post" action="action_submit_tcu.php">-->
                    <table id="admit" class="display" cellspacing="0" width="100%">
                       ...
                       /* $db=new DBHelper();*/
                        $count=1;
                        $applicants=$db->getDataTCUView($programmeID,$academicYearID,$admissionID);
                        if(!empty($applicants)) {
                            foreach ($applicants as $app) {
                                ...
                                $tcu_final = $app['tcu_final'];
                                $tcu_message = $app['tcu_message'];
                                $formfourtcu=$app['formfour'];
                               ...
                               /* if ($tcu_final == "Multiple Admission") {
                                    $confirm = "<a href='index3.php?sp=confirm_applicant_tcu&formfour=$formfourtcu'>Confirm</a>";
                                } else {
                                    $confirm = "No";
                                }*/
                                if(!empty($tcu_final)) {
                                    $tcu_final = $tcu_final;
                                    $tcu_message=$tcu_message;
                                }
                                else {
                                    $tcu_final = "None";
                                    $tcu_message="None";
