	                            ...
	                            <form name="register" id="register" method="post" action="confirm_profile.php">
                                    ...
                                    <div class="row">
											...
											<option value="">Choose Examination Authority for your first sitting at O-Level (FIV)</option>
                                                <option value="NECTAO">National Examination Council of Tanzania (NECTA)-2018</option>
												<option value="NECTA">National Examination Council of Tanzania (NECTA) 1987-2017</option>
                                        ...
                                        <div class="NECTAO">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="sr-only" for="form-index-number">Index Number</label>
                                                    <input type="text" name="indexNumberO" id="indexNumberO" placeholder="Index Number..." class="form-index-number form-control" id="form-index-number">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
										...
										<div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nfname" id="fname" placeholder="First name..." class="form-first-name form-control" required>
                                                </div>
                                            </div>
										...
										<div class="form-group">
				                        	...
				                        	<input type="text" name="nmname" id="mname" placeholder="Middle name..." class="form-middle-name form-control">
	                        			</div>
										</div>
                                        </div>
										...
										<div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nlname" id="lname" placeholder="Last name..." class="form-last-name form-control" required>
                                                </div>
                                            </div>
										<div class="col-sm-6">
										<div class="input-group">
											<span class="input-group-addon"><span>
											<select name="ngender" id="gender" class="form-control selectpicker" required>
                                    ...
                                    <div class="Others">
				                        ...
				                        <div class="form-group">
                                            ...
                                            <div class="NECTAO">
                                                <div class="form-group">
                                                    <label class="sr-only" for="form-telephone">Email Address</label>
                                                    <input type="text" name="nemailad" placeholder="Valid email address..." class="form-email form-control">
                                                </div>
                                            </div>
                                            <div class="Others">
                                                <div class="form-group">
