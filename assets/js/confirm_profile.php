...
if(isset($_REQUEST['action_type']) && !empty($_REQUEST['action_type'])) {
    if ($_REQUEST['action_type'] == 'confirm') {
        ...
        {
            $indexNumber = $_POST['indexNumberO'];
            $exam_year=$_POST['indexYear'];
            $fname = strtoupper($_POST['nfname']);
            $mname = strtoupper($_POST['nmname']);
            $lname = strtoupper($_POST['nlname']);
            $gender = $_POST['ngender'];
            $phoneNumber = $_POST['phoneNumber'];
            $email = $_POST['nemailad'];
            $indexNumber=$indexNumber."/".$exam_year;
            $boolStatus=true;
        }
    }
                            ...
                            <form name="" id="" method="post" action="action_confirm_register.php">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                       ...
                                       <!-- <button type="submit" class="btn" name="doProceed">Proceed to Application</button>-->
                                        <?php
...
<![endif]-->
<p> <font color="white"><strong>Programmes| How to apply | FAQ | Support:+255 785 330 002 </strong></font></p>
</body>
