...
<?php
                        ...
                        /*else if($tcu_final=="Qualified"||$tcu_final=="confirmed" ||$tcu_final=="Admitted")*/
                        else if($remarkID==3)
                        {
                            if($db->checkApplicantStudyLevel($applicantID==1))
                            {
    ...
    if($today<=$endDate)
    {
        ...
        <?php if ($remarkID == 7 ||  $remarkID == 5) {
            ...
            <a href="index.php?sz=education_background"><span
                        class="btn btn-primary align-left">Proceed  Application</span></a>
            <?php
            }
            else
            {
                ?>
                <a href="index.php?sz=pg_education"><span
                            class="btn btn-primary align-left">Proceed  Application</span></a>
            <?php
            }
        }
