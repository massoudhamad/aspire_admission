...
<div class="col-lg-12"> 
    ...
    if(!empty($results)) {
                ...
                <fieldset>
                    ...
                    foreach ($results as $matokeo) {
                        ...
                        <table class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                            ...
                            <td>
                                ...
                                if ($resultStatus == 1) {
                                    ...
                                    {
                                    ?>
                                    <a href="action_ordinary_level.php?action_type=dropSchool&id=<?php echo $applicantResultID; ?>"
                                       onclick="return confirm('Are you sure you want to drop this school and all results?');"><span
                            ...
                            <table class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                                ...
                                foreach ($resultSubjects as $subject) {
                                    ...
                                    <td>
                                        ...
                                        if ($resultStatus == 0) {
                                            ?>
                                            <a href="action_ordinary_level.php?action_type=dropSubject&id=<?php echo $applicantSubjectID; ?>"
                                               class="text-danger"
                        ...
                        if ($resultStatus != 1) {
                            ?>
                            <div class="row">
                                <div class="col-lg-10"></div><div class="col-lg-2 pull-right">
                                    <a href="index.php?sz=newsubject&id=<?php echo $applicantResultID; ?>&indexYear=<?php echo $yearTaken; ?>&level=olevel"><span
                                                class="btn btn-primary">Add Other Subject</span></a>
                                </div></div>
                            <?php
                        }
                        ?>
        ...
        <div class="col-lg-12">
            ...
            <a href="index.php?sz=other_ordinary"><i class="glyphicon glyphicon-hand-right"></i> <span
                        class="btn btn-primary">Add Other School</span></a>
        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-condensed" cellspacing="0"
                                        ...
                                        <td>
                                            ...
                                            if ($resultStatus == 0) {
                                                ?>
                                                <a href="action_ordinary_level.php?action_type=dropSchool&id=<?php echo $applicantResultID; ?>"
                                                   onclick="return confirm('Are you sure you want to drop this school and all results?');">
                                                ...
                                                <td><?php echo $totalPoints; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="index.php?sz=newsubject&id=<?php echo $applicantResultID; ?>&indexYear=<?php echo $yearTaken; ?>&level=alevel">
                                                            <span class="btn btn-primary">Add Other Subject</span</a>
                                                            <?php
                                                        }
                                                        else
                                                        {
            ...
            <div class="col-lg-12">
                <fieldset>
                    ...
                    if (!empty($equivalentresults)) {
                                    ...
                                    <table class="table table-striped table-bordered table-condensed" cellspacing="0"
                                        ...
                                        <td>
                                            ...
                                            if($matokeo['resultStatus']==1)
                                            {
                                                ...
                                                ?>
                                                <a href="action_equivalent_results.php?action_type=dropSchool&id=<?php echo $applicantResultID; ?>"
                                                   class="glyphicon glyphicon-trash"
                                                   onclick="return confirm('Are you sure you want to drop this results?');">Drop</a>
                                                <?php
                                            }
                                            ?>
                                        </td>
                        ...
                        ?>
                        <label class="col-lg-12 control-label">If you have Equivalent Level Results, Click Here <a
                                    href="index.php?sz=equivalent"><span class="btn btn-primary"> Add Equivalent Level Results</span></a></label>
                    <?php } ?>
                </fieldset>
            </div>
