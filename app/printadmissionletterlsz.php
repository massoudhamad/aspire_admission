...
{   
   ...
   foreach($applicantsData as $apps)
   {
      ...
      $pdf->Ln(8);
      $pdf->Cell(6);$pdf->Cell(101,6,"Dear Esteemed Student","0");
     ...
     $pdf->Ln(8);
      ...
      //pdf content
       ...
       $pdf->Cell(6);$pdf->MultiCell(0,6, "The admission offer is provisional pending verification of the qualifications as presented on your online application. You will be required at the time of registration, to present in person the original documents you have used in the application. I would, therefore, like to put an emphasis on the following must be presented to the School:");

       $pdf->Cell(10);$pdf->MultiCell(0,6, "i.   The original Certificate of Ordinary Secondary Education (For IV);");
       $pdf->Cell(10);$pdf->MultiCell(0,6, "ii.  The original Degree of Law or its equivalent or certified evidence to prove possession of it;");
       $pdf->Cell(10);$pdf->MultiCell(0,6, "iii. The original Advanced Certificate of Secondary Education;");
       $pdf->Cell(10);$pdf->MultiCell(0,6, "iv.  Where applicable the relevant original Degree or Diploma or Certificate and Transcript;");
       $pdf->Cell(10);$pdf->MultiCell(0,6, "v.   Four passport size photographs.");
       $pdf->Ln(4);
       $pdf->Cell(6);$pdf->MultiCell(0,6, "Congratulations and we are looking forward to see you at the School.");
       $pdf->Ln(4);$pdf->Cell(6);$pdf->MultiCell(0,6, "Please find the attached Fee Structure.");
