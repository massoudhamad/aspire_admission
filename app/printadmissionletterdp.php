   ...
   foreach($applicantsData as $apps)
   {
     ...
     $pdf->Ln(8);
      ...
      //pdf content
       ...
       $pdf->Ln(4);
       $pdf->Cell(6);$pdf->MultiCell(0,6, "Registration and Orientation will commence on 17th October, 2022 and you are required to present yourself at the Admission Office for registration after paying the required registration fee of Tanzanian Shillings Two Hundred and twenty thousand and Four Hundred (220,400/=) through Account name: SUMAIT University and Account Number: 0710412000 PBZ ISLAMIC BANK.  Failure to do so, may result into withdrawal of your admission at the University.");
       $pdf->Ln(4);
