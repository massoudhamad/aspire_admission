                            ...
                            <div class="col-lg-12">
                                  <h3>  List of Academic Background Results</h3>
                                        ...
                                        <table class="table table-striped" cellspacing="0" width="100%">
                                            ...
                                            <td>
                                                <a href="action_academic_background.php?action_type=dropSchool&id=<?php echo $db->my_simple_crypt($academicID,'e'); ?>"
...
<div class="modal fade" id="add_new_record_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <input type="text" id="programmeName" name="programmeName" placeholder="Programme Name" class="form-control" />
            </div>

            <div class="form-group">
            <label for="email">Institution Name</label>
        <input type="text" id="code" name="instituteName" placeholder="University/Institution Name" class="form-control" />
            </div>
        ...
        <input type="text" id="cgpa" name="cgpa" placeholder="Enter CGPA/Class/Division/%" class="form-control" />
            </div>
