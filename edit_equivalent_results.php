...
if(!empty($_REQUEST['msg']))
{
  if($_REQUEST['msg']=="error")
  {
    ...
    <strong>Sory-There is an error in your data, Please check your and resubmit again</strong>.
</div>";
  }
...
<form class="form-horizontal" name="register" id="register" action="action_edit_equivalent_results.php" method="post">   
<div class="col-lg-12">    
              <div class="well">
                  <fieldset>
