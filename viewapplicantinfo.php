                        ...
                        <div class="well">
                            ...
                            <div class="row">
                                <form name="" method="post" id="register" action="action_approve.php">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                ...
                                                <input type="hidden" name="formfour" value="<?php echo $formfour; ?>">
                                                <input type="hidden" name="formsix" value="<?php echo $findexNumber; ?>">
                                                <input type="hidden" name="appcategory" value="<?php echo $category; ?>">
                                                <input type="submit" name="doSubmit" value="Change Status" class="btn btn-success form-control" />
                                            <?php
                                            }
                                            ?>
                                            </a>
                                    ...
                                    ?>
                                        <div class="col-lg-4">
                                            <a href="index3.php?sp=register_applicant&applicantID=<?php echo $applicantID; ?>&formfour=<?php echo $formfour; ?>"><span class="btn btn-danger">Register Student</span></a>
                                            </a>
                                        </div>
                                        <?php
                                                //}
                                        ...
                                        */ ?><!--
                                        ...
                                        --><?php
                                            ...
                                            ?>
                                            <div class="col-lg-4">
                                                <a data-toggle="modal" href="transferapplicant.php?id=<?php echo $applicantID; ?>&programmeMajorID=<?php echo $firstChoice; ?>" data-target="#oModal" class="btn btn-warning">Transfer Student</a></td>
                                                </a>
                                            </div>
                                        <?php
                                                }
