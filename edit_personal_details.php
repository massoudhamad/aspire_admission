...
<div id="" class="">
    ...
    foreach($applicantsData as $apps)
    {
       ...
       $avn=$apps['avnumber'];
    ?>
    <form action="action_edit_registration_form.php" method="post" name="register" id="register">
                ...
                <fieldset>
                  ...
                  <legend>Sponsorship Information</legend>
                    ...
                    <fieldset>
                  <legend>AVN Information</legend>
               
                    <div class="row">
                    <div class="col-lg-3">
                         
                      <label for="MiddleName">AVN Number</label>
                            <input type="text" name="avnumber" value="<?php echo $avn;?>"  class="form-control" />
                     </div>   
                    </div></fieldset>
