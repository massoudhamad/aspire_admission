...
$applicantsData=$db->getApplicantsSponsorList($programmeID,$academicYearID,$admissionID,1,$sponsor);
    ...
    foreach ($applicantsData as $data)
    {
        ...
        if(!empty($oindexumber))
        {
            ...
            foreach ($oindexumber as $fnumber) {
                ...
                $f4division=$fnumber['division'];
                $f4points=$fnumber['points'];
