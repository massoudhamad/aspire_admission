...
$applicantsData = $db->getRows("applicants", array('where' => array('admissionLevel'=>'PG','applicationYearID' => $applicationYearID, 'admissionID' => $admissionID, 'applicantsRemarksID' => 1), 'order_by firstName ASC'));
if (!empty($applicantsData)) {
    ...
    foreach ($applicantsData as $row) {
        ...
        $actionButton = '
	<div class="btn-group">
	    <a href="index3.php?sp=pgapplicantdetails&applicantID=' . $row['applicantID'] . '"><span class="glyphicon glyphicon-edit"></span> Approve</a>
	</div>';
