            ...
            <div class="col-lg-12">
                ...
                */ ?>
                ...
                <div class="form-group">
                  <label for="qualificationType">Highest level of Education</label>
                ...
                <div class="col-lg-6">
                <div class="form-group">
                  <label for="studyLevel">Study Level Applied</label>
             ...
             <a href="index3.php?sp=edit_study&applicantID=<?php /*echo $applicantID;*/ ?>"><span class="btn btn-primary pull-right">Edit Study Levels</span></a>
    ...
    <div class="col-lg-12">
        <fieldset>
            <div class="well">
                ...
                <?php
                /*$results=$db->getRows("applicantresults", array('where'=>array('applicantID'=>$applicantID,'applicantResultStatus'=>1,'examinationLevel'=>'Ordinary'),'order_by applicantID ASC'));
     if(!empty($results))
     {*/
                ?>
                <div class="row">
        ...
        ?>
                ...
                <div class="well">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <?php
                            $identificationNumber = $db->getRows("applicant_identification", array('where' => array('applicantID' => $applicantID), 'order_by applicantID ASC'));
                            if (!empty($identificationNumber)) {
                                foreach ($identificationNumber as $idnumber) {
                                    $znzID = $idnumber['zanzibarID'];
                                    $nidaID = $idnumber['nationalID'];
                                    $passport = $idnumber['passportNumber'];
                                }
                            } else {
                                $znzID = "";
                                $nidaID = "";
                            ...
                            ?>
                            <div class="col-lg-3">
                                <label for="FirstName">Zanzibar ID</label>
                                <input type="text" name="znzID" value="<?php echo $znzID; ?>" class="form-control" disabled />
                            </div>

                            <div class="col-lg-3">
                                <label for="MiddleName">National Identification Number(NIDA)</label>
                                <input type="text" name="nidaID" value="<?php echo $nidaID; ?>" class="form-control" disabled />
                            </div>
                            <div class="col-lg-3">
                                <label for="LastName">Passport Number</label>
                                <input type="text" name="passport" value="<?php echo $passport; ?>" class="form-control" disabled />
                            </div>
                        </div>
                    </fieldset>
                                        ...
                                        <select name="remarksID" class="form-control" required="">
                                            ...
                                            if (!empty($remarks)) {
                                                ...
                                                foreach ($remarks as $rmk) {
                                                    ...
                                                    if ($remarkID==2 || $remarkID==4 || $remarkID==5) {
                                                        ?>
