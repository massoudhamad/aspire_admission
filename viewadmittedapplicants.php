 ...
 <div class="col-lg-3">
    ...
    <div class="row">
        ...
        if(isset($_POST['doSearch'])=="Search Records")
        {
            ...
            ?>
         <div class="col-lg-12">
            <h4><span id="titleheader">List of Admitted Applicants for <?php echo $db->getData("programmemajor","programmeMajor","programmeMajorID",$programmeID);?><!---
...
-->           </tr>
         ...
         <?php
                if($programmeMajorID=='all') {
                    $applicantsData = $db->getAllAdmitted($programmeID, 3, 1, $applicationYearID, $admissionID);
                }
                else
                {
                    $applicantsData = $db->getAdmitted($programmeMajorID, 3, 1, $applicationYearID, $admissionID);
                }
                     ...
                     foreach ($applicantsData as $data)
                     {
                         ...
                         if($nacte_status==0)
                            echo "<input type='checkbox' class='checkbox_class' name='id[]' value='$applicantID'>";
                             ...
                             echo "NA";
                         echo"</td><td>$name</td>"
                                 . "<td>$gender</td><td>$phoneNumber</td><td>".$db->getData("users","userName","userID",$userID)."</td><td>$refNumber</td><td>$tcu_status</td>";
                        ?>
