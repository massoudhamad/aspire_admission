...
try {
    ...
    if(isset($_POST['doAdmit']) == 'Submit Applicants')
    {
        ...
        foreach($_POST['applicantID'] as $applicantID)
        {
            ...
            <Request>
                ...
                <RequestParameters>
                    ...
                    <AdmissionStatus>not admitted</AdmissionStatus>
                    <ProgrammeAdmitted></ProgrammeAdmitted>
       ...
       if ($boolStatus) {
            header("Location:index3.php?sp=submit_unselected_tcu&msg=succ&count=".$jj);
            $_SESSION['output'] = $msgs;
        } else {
            header("Location:index3.php?sp=submit_unselected_tcu&msg=unsucc");
            $_SESSION['output'] = $msgs;
        }
    ...
    $db->redirect("index3.php?sp=submit_unselected_tcu&msg=error");
}