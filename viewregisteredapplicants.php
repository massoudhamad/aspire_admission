...
<div class="container">
    ...
    <div class="row">
        ...
        ?>
            <div class="col-lg-12">
                <h4><span id="titleheader">List of Registered Applicants for <?php echo $db->getData("programs", "programName", "programID", $programmeID); ?><!---
              --><?php /*echo $entrychoice;*/ ?></span></h4>
            </div>
                ...
                <table id="admit" class="display nowrap" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        if ($programmeMajorID == 'all') {
                            $applicantsData = $db->getAllRegistered($programmeID, $applicationYearID, $admissionID);
                        } else {
                            $applicantsData = $db->getRegisteredApplicants($programmeMajorID, $applicationYearID, $admissionID);
                        }
                        if (!empty($applicantsData)) {
                            ...
                            foreach ($applicantsData as $data) {
                                ...
                                echo "<tr>";
                                if ($nacte_status == 0)
                                    echo "<td><input type='checkbox' class='checkbox_class' name='id[]' value='$applicantID'></td>";
                                else
                                    echo "<td>NA</td>";
                        ...
                        ?>
                                <td>
                                    ...
                                    ?>
                                        <a data-toggle="modal" href="transferapplicant.php?id=<?php echo $applicantID; ?>&programmeMajorID=<?php echo $programmeMajorID; ?>
                            " data-target="#oModal" class="btn btn-link">Transfer</a>
                                    <?php
                                    } else {
                                        echo "No";
                                    }
                                ...
                                /*                                if($_SESSION['role_session']==3) {
                                    */ ?>
                                    <a data-toggle="modal"
                                       href="drop_applicant.php?id=<?php /*echo $applicantID; */ ?>&programmeMajorID=<?php /*echo $programmeID; */ ?>
                            " data-target="#oModal" class="btn btn-link">Drop</a>
                                    <?php
                                    /*                                }
                                else
                                {
