    ...
    <div class="col-lg-12">
        ...
        <div class="well">
            ...
            if($applicantsRemarksID==6) {
                ?>
                <legend><h1><div class="pull-right"><a href="printform.php?action=getPDF&applicantID=<?php echo $applicantID;?>" target="_blank"> Print Form</a></div></h1></legend>
            <?php
            }
            else
            {
            ?>
                ...
                <legend><h1>Please Verify the following Information</h1></legend>
                <?php
                }
                ?>
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" name="" value="2019/2020" class="form-control" disabled="">
