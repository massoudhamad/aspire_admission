...
<!-- 				                        <input type="submit" name="doLogin" class="form-control btn btn-default btn-success input-lg" value="Sign In!"> -->
	                            ...
	                            <form name="register" id="register" method="post" action="confirm_profile.php">
                                    ...
                                    <div class="row">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="sr-only" for="Email">Equivalent Number</label>
                                                    <input type="text" name="equivalence_number" id="equivalence-number" placeholder="Equivalence Number..." class="form-control" id="equivalence-number">
                                    ...
                                    <div class="PG">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="input-group">
											<span class="input-group-addon"><span>
											<select name="pgender" id="gender" class="form-control selectpicker" required>
												<option value="">Please select you Gender</option>
												<option>Male</option>
												<option>Female</option>
											</select>
				                        ...
				                        <div class="form-group">
                                            ...
                                            <div class="NECTAO">
                                                <div class="form-group">
                                                    <label class="sr-only" for="form-telephone">Email Address</label>
                                                    <input type="text" name="nemailad" placeholder="Valid email address..." class="form-control required email">
                                                </div>
                                            </div>
                                            <div class="Others">
                                                <div class="form-group">
    ...
    <script src="assets/js/jquery.mask.min.js"></script>
        ...
        <![endif]-->
		<p> <font color="white"><strong> Programmes| How to apply | FAQ | Support: <?php echo $studentSupport;?></strong></font></p>
    </body>
