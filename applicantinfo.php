                ...
                <div class="well">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            $fname=$db->getData("users","firstName","userID",$userID);
                            $mname = $db->getData("users", "middleName", "userID", $userID);
                            $lname = $db->getData("users", "lastName", "userID", $userID);
                            $name="$fname $mname $lname";
                            ?>
                            Approved By: <?php echo $name;?> Processed Date: <?php echo $processDate;?>
                        </div>
                    </div>
                </div>
        <?php }
