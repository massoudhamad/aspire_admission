                  ...
                  <div class="row">
                       ...
                       <?php
                        ...
                        <div class="ndio"><div class="col-lg-3">
                            ...
                            <input type="text" name="dname"  value="<?php echo $disabilityName;?>" class="form-control" required="" />
                        </div>

                        <div class="col-lg-6">
                            <label for="MiddleName">Disability Description</label>
                            <input type="text" name="ddescription" value="<?php echo $disabilityDescription;?>"  class="form-control" required="" />
                        </div>
                  ...
                  <legend>Employment Information</legend>
                    ...
                    <div class="row">
                        ...
                        <div class="yes"><div class="col-lg-3">
                            ...
                            <input type="text" name="employer" value="<?php echo $employer;?>" class="form-control" required="" />
                        </div>

                        <div class="col-lg-3">
                            <label for="MiddleName">Address/Place of Work</label>
                            <input type="text" name="placework" value="<?php echo $placework;?>"  class="form-control" required="" />
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                       ...
                       ?>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" name="sponsorname" value="<?php echo $sponsorname;?>" class="form-control" required=""/>
                        </div>

                        <div class="col-lg-3">
                            <label for="MiddleName">Address</label>
                            <input type="text" name="sponsoraddress" value="<?php echo $sponsoraddress;?>"  class="form-control" required="" />
                        </div>
                        <div class="col-lg-3">
                            <label for="MiddleName">Phone Number</label>
                            <input type="text" name="sponsorphonenumber" value="<?php echo $sponsorphone;?>"  class="form-control" required="" />
                        </div>
                        </div>
