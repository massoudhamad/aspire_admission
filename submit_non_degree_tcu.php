...
<div class="container">
    ...
    <div class="row">
        ...
        if (isset($_POST['doSearch']) == "Search Records") {
            ...
            <form name="register" id="register" method="post" action="action_submit_non_degree_tcu.php">
                <table id="selection_list" class="display nowrap" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <?php
                        $applicantsData = $db->getSubmitSelectedListNonDegreeTCU($academicYearID, $admissionID);
