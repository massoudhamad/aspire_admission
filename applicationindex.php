...
<div class="row">
    ...
    <strong>SUCCESSFULLY_CONFIRMED TO TCU SYSTEM</strong>.
</div>";
                }
                else if($_REQUEST['msg']=="unsucc")
                {
                    echo "<div class='alert alert-danger fade in'><a href='#' class='close' data-dismiss='alert'>&times;</a>
    <strong>Sorry,UN_SUCCESSFULLY_CONFIRMED,Please Contact MUM Admission Office</strong>.
</div>";
                }*/
            }
            ?>
    ...
    <div class="col-lg-12">
        ...
        if(!empty($applicantsData)){
            foreach($applicantsData as $apps)
            {
                ...
                if(($remarkID==3 && ($tcu_final=="Qualified" ||$tcu_final=="Multiple Admission")) || $remarkID==6)
                {
                ...
                {
                    ?>
                    <h3>Congratulations,Your application has been recored, you will be notified for any changes of status,please keep login to our system for any updates.</h3>
                    <?php
                }
                else if($remarkID==3)
                {
                ...
                <table class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                    ...
                    <tr>
                            ...
                            if($remarkID==3) {
                                if($db->checkApplicantStudyLevel($applicantID)==1) {
                                    if (!empty($tcu_final)) {
                                        ...
                                        else if($tcu_final=="Multiple Admission"){
                                            echo $tcu_final."<br>";
                                           echo"Please <a href='index.php?sz=confirm_applicant_tcu&formfour=$formfour'>Confirm</a> of your Admission";
                                            echo "<b>Programme Admitted:</b><br>";
                                            $progAdd = $db->getAdmittedProgrammeMajor($applicantID);
                                            if (!empty($progAdd)) {
                                                foreach ($progAdd as $pChoice) {
                        ...
                        else if($remarkID==3 && ($tcu_final=="Qualified"||$tcu_confirm==1))
                        {
                            ?><td>
    ...
    if($today<=$endDate)
    {
        ...
        <?php if ($remarkID == 7 ||  $remarkID == 5) {
            ?>
            <a href="index.php?sz=education_background"><span
                        class="btn btn-primary align-left">Proceed to Application</span></a>
            <?php
        }
        ?>
...
if($remarkID==6)
{
    ...
    if(!empty($upload))
    {
        ?>
        <div class="row">
            <div class="pull-center"><h4>Documents Downloads</h4></div>
        </div>
        <div class="row">
            <table class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
