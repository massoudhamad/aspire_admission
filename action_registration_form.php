...
if(isset($_REQUEST['action_type']) && !empty($_REQUEST['action_type'])){
    ...
    if($boolStatus)
    {
        header("Location:index2.php?sz=confirm_registration");
    }
    else
    {
        header("Location:index2.php?sz=registration_form&msg=unsucc");
    }
}

} catch (PDOException $ex) {
    header("Location:index2.php?sz=registration_form&msg=error");
